<template>
  <div>
    <div class="positionContainer">
      <Sidebar @keepshow="keepaside" @prevClick="presideDiss" :open="showSideBar" @togglenav="closeside"></Sidebar>
...
export default {
  ...
  methods: {
    ...
    loginEvent () { // 當你按下按鈕發生的事件
      ...
      URL += '&state=dev123456' // 用來防止跨站請求的 之後回傳會傳回來給你驗證 通常設亂數 這邊就先放123456789
